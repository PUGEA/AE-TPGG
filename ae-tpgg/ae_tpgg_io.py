...
def read_dataset(adata, transpose=False, test_split=False, copy=False):
    ...
    if test_split:
        ...
        adata.obs['ae_tpgg_split'] = spl.values
    else:
        adata.obs['ae_tpgg_split'] = 'train'

    adata.obs['ae_tpgg_split'] = adata.obs['ae_tpgg_split'].astype('category')
    print('ae_tpgg: Successfully preprocessed {} genes and {} cells.'.format(adata.n_vars, adata.n_obs))
...
def read_genelist(filename):
    ...
    print('ae_tpgg: Subset of {} genes will be denoised.'.format(len(genelist)))
